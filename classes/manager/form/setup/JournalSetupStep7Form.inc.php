...
/**
 * @file classes/manager/form/setup/JournalSetupStep7Form.inc.php
 *
 * @class JournalSetupStep7Form
 * @ingroup manager_form_setup
 *
 * @brief Form for Step 7 of journal setup.
 */
...
class JournalSetupStep7Form extends JournalSetupForm {
        /**
         * Constructor.
         */
        function JournalSetupStep7Form() {
        ...
        function display($request, $dispatcher) {
                ...
                # Special URL is used to reach Subi's batch page.
                $templateMgr->assign('subiURL',
                         ($_SERVER["HTTPS"] ? 'https://' : 'http://') . $_SERVER["SERVER_NAME"] . 
                        '/subi/batch?configView=compact&entity=' . $journal->getPath());
