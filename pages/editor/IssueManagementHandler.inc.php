				...
				if (empty($result)){
				   error_log("No articles in TOC!");
                    ...
                    $rawQualifiedArk = shell_exec("source /apps/eschol/.bashrc && /apps/eschol/subi/xtf-erep/control/tools/mintArk.py ojs $singleArticleID 2>&1");                                          
					 ...
					 $owner = array("ao4elt4"=>'ucolick',"cjpp"=>'ucb-eschol', "irows_cliodynamics"=>'ucr-jclio', "bling_proceedings"=>'ucb-bls', "biogeographia"=>'ucm_mndawson', "fb"=>'ucm_mndawson', "class_lta"=>'uci-jlta', "ucbgse_bre"=>'ucb-eschol', "himalayanlinguistics"=>'sb-eschol', "uccllt_l2"=>'ucb-eschol', "equilibrium"=>'ucsd_library', "refract"=>'ucsc-lib', "teachinglearninganthro"=>'uci-eschol', "ucb_crp_bpj"=>'ucb-eschol', "territories"=>'sb-eschol', "vertebrate_pest_conference"=>'ucd-library', "dotawo"=>'sb-eschol', "diagonal"=>'ucr-eschol', "jevohealth"=>'ucla-eschol', "psf"=>'ucb-eschol', "uclalib_egj"=>'ucla-eschol', "ssha_uhj"=>'ucm-eschol', "ucm_mwp_thevernalpool"=>'ucm-eschol', "ssha_transmodernity"=>'ucm-eschol', "ucm_mwp_ucmurj"=>'ucm-eschol', "our_bsj"=>'ucb-eschol', "our_buj"=>'ucb-eschol', "ismrg_cisj"=>'ucb-eschol', "languagesofcaucasus"=>'ucb-eschol', "ucmp_paleobios"=>'ucb-eschol', "crg_raceandyoga"=>'ucb-eschol', "ucbgerman_transit"=>'ucb-eschol', "doj"=>'ucd-eschol', "ucdavislibrary_streetnotes"=>'ucd-eschol', "dmj"=>'uci-eschol', "uciem_jetem"=>'uci-eschol', "alephucla"=>'ucla-eschol', "uclalaw_apalj"=>'ucla-eschol', "italian_ucla_carteitaliane"=>'ucla-eschol', "uclalaw_cllr"=>'ucla-eschol', "uclaspa_criticalplanning"=>'ucla-eschol', "gseis_interactions"=>'ucla-eschol', "uclapsych_ijcp"=>'ucla-eschol', "appling_ial"=>'ucla-eschol', "uclalaw_jinel"=>'ucla-eschol', "ucla_spanport_mester"=>'ucla-eschol', "uclalaw_pblj"=>'ucla-eschol', "ucla_french_pg"=>'ucla-eschol', "queercatsjournal"=>'ucla-eschol', "imbs_socdyn_sdeas"=>'ucla-eschol', "uclastat_cts_tise"=>'ucla-eschol', "uclalaw_cjlr"=>'ucla-eschol', "uclalaw_elr"=>'ucla-eschol', "uclalaw_jelp"=>'ucla-eschol', "uclalaw_wlj"=>'ucla-eschol', "international_asc_ufahamu"=>'ucla-eschol', "iocv_proceedings"=>'ucr-eschol', "iocv_journalcitruspathology"=>'ucr-eschol', "ucr_undergrad_research_journal"=>'ucr-eschol', "ucsb_soc_jcmrs"=>'sb-eschol', "acgcc_jtas"=>'sb-eschol', "lawandpoliticaleconomy"=>'ucd-eschol', "nes_jagnes"=>'ucb-eschol', "jisc"=>'ucsc-eschol', "kinship"=>'ucla-eschol', "ucla_rsp"=>'ucla-eschol', "alonfilipinxjournal"=>'ucd-eschol', "aarj"=>'ucb-eschol', "reactreview"=>'sb-eschol', "ncs_pedagogyandprofession"=>'ucsd_eschol', "pacificarts"=>'ucsc-eschol', "combinatorial_theory"=>'ucd-eschol', "jwa"=>'ucd-eschol', "jsys"=>'ucsc-eschol' );
